...
@section('inner-title', __('penghargaan::general.edit.title', ['attribute' => $title]) . ' - ')
	...
	<section class="box-typical">
		...
		{!! Form::model($edit, ['route' => ["$prefix.update", $edit->uuid], 'autocomplete' => 'off', 'files' => true, 'method' => 'PUT']) !!}
	    	...
	    	@include('core::layouts.components.top', [
                'judul' => __('penghargaan::general.edit.title', ['attribute' => $title]),
                'subjudul' =>  __('penghargaan::general.edit.desc'),
